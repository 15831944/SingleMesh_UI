...
public class ModelMeshEditorTop : MonoBehaviour
{
    ...
    public void CreateEditorPoint()
    {
        ...
        foreach (string key in pointmap.Keys)
        {
            ...
            GameObject editorpoint = (GameObject)Resources.Load("Prefabs/MeshEditor/MeshEditorPointTop");
            ...
            MeshEditorPointTop editorPoint = editorpoint.GetComponent<MeshEditorPointTop>();

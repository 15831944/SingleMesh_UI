...
public class ModelMeshEditorSide : MonoBehaviour
{
    ...
    public void CreateEditorPoint()
    {
        ...
        foreach (string key in pointmap.Keys)
        {
            ...
            GameObject editorpoint = (GameObject)Resources.Load("Prefabs/MeshEditor/MeshEditorPointSide");
            ...
            MeshEditorPointSide editorPoint = editorpoint.GetComponent<MeshEditorPointSide>();

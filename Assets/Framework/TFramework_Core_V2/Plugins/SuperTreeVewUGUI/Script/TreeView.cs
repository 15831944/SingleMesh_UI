...
namespace SuperTreeView
{
    ...
    public class TreeView : TreeList
    {
        ...
        {
            Debug.LogError(mNeedReposition);
            mItemPoolDict.Clear();
            mTreeItemList.Clear();
            mTreeViewItemDict.Clear();
            mAllTreeViewItemList.Clear();
            //mCurTreeItemDictVersion = 0;
            Init();
        }
        ...
        public void InitView()
        {
            ...
            if (CachedRectTransform.transform.Find("ItemPool") == null)
            {
            ...
            {
                poolObj = CachedRectTransform.transform.Find("ItemPool").gameObject;
            }

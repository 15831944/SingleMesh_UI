...
public class TView : MonoBehaviour {

    public static TView Content { get; set; }
    ...
    //图层列表，用于其他元检索
    public Dictionary<string, TLayer> Layers;

    void Awake()
    {
        Content = this;
        Layers = new Dictionary<string, TLayer>();
    ...
    public void Set(DXFStructure dxf)
    {
        ...
        TLayer.DefaultLayer = goDefaultLayer.GetComponent<TLayer>();
        //TLayer.DefaultLayer.ZoomAdjust = 0.8f;
